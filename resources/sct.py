...
class TSNE():
    ...
    def plot(self, fig, ax, colorBy=None, colorMode="gene", markeredgewidth=0.0, **kwargs):
        ...
        if colorMode == "gene":
            ...
            sc = ax.scatter(self.X_tsne[:,0], self.X_tsne[:,1], s=20, edgecolor="k", linewidths=0.25, c=C, norm=norm, **kwargs)
        else:
            sc = ax.scatter(self.X_tsne[:,0], self.X_tsne[:,1], s=20, edgecolor="k", linewidths=0.25, c=C, **kwargs)
